            ...
            <div class="panel-body">
                <form action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <textarea class="form-control" name="about_us" name="about_us" id="about_us"><?php echo get_frontend_settings('about_us'); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <textarea class="form-control" name="terms_and_condition" name="terms_and_condition" id="terms_and_condition"><?php echo get_frontend_settings('terms_and_condition'); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <textarea class="form-control" name="privacy_policy" name="privacy_policy" id="privacy_policy"><?php echo get_frontend_settings('privacy_policy'); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <textarea class="form-control" name="faq" name="faq" id="faq"><?php echo get_frontend_settings('faq'); ?></textarea>
                            </div>
                        </div>
                    </div>
