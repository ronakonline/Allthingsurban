...
<script type="text/javascript" src="<?php echo base_url('assets/backend/js/datatable/datatables/js/jquery.dataTables.js');?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/backend/js/datatable/datatables/js/dataTables.bootstrap.js');?>"></script>
