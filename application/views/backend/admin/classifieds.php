...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title">
                    <?php echo get_phrase('classified'); ?>
                </div>
            </div>
            <div class="panel-body">
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo site_url('admin/classifieds_form/edit/'.$listing['id']); ?>"><?php echo get_phrase('edit'); ?></a></li>
                                        ...
                                        <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/classifieds/delete/'.$listing['id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
    ...
    $(document).ready(function() {
        $(".checkMark").click(function(){
            ...
            $('#delete_listings').click(function(){
                ...
                $.ajax({
                    url: '<?php echo site_url('admin/classifieds/classifieds_delete/'); ?>'+ listings_id,
                    success: function(response){
                        location.reload();
                    }
                });
