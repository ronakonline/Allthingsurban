    ...
    <div class="col-lg-10">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo site_url('admin/classified_categories/edit/').$category[0]->id; ?>" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered">

                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label"><?php echo get_phrase('category_title'); ?></label>

                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $category[0]->sub_name; ?>">
                        </div>
                    </div>
                                ...
                                <?php foreach ($categories as $categories): ?>
                                    <?php if ($categories['parent'] == 0): ?>
                                        <option value="<?php echo $categories['id']; ?>" 
                                            <?php if ($category[0]->parent == $categories['id']) 
                                                {?>selected <?php } ?>>
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;" data-trigger="fileinput">
                                    <?php if ($category[0]->banner==""): ?>
                                        <img src="<?php echo base_url('uploads/classified_category_tumbnail/thumbnail.png'); ?>">

                                    <?php else: ?>
                                        <img src="<?php echo base_url('uploads/classified_category_tumbnail/').$category[0]->banner; ?>">
                                    <?php endif; ?>
                    ...
                    <div class="col-sm-offset-3 col-sm-5" style="padding-top: 10px;">
                        <button type="submit" class="btn btn-info"><?php echo "Update Category"; ?></button>
                    </div>
                </form>
            </div>
        </div>
