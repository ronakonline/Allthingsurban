...
$time_configuration_details = $this->crud_model->get_time_configuration_by_classifieds_id($listing_id)->row_array();
...
<form action="<?php echo site_url('admin/classifieds/edit/'.$listing_id); ?>" method="post" role="form" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
