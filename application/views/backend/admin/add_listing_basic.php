...
<div class="form-group">
  ...
  <div class="col-sm-7">
    <input type="text" class="form-control" name="google_analytics_id" id="google_analytics_id" placeholder="<?php echo get_phrase('title'); ?>" placeholder="GA_MEASUREMENT_ID">
  </div>
</div>
<div class="form-group">
