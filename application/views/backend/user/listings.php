<div class="row ">
    <div class="col-lg-12">
        <?php if (has_package() > 0): ?> <a href="<?php echo site_url('user/listing_form/add'); ?>" class="btn btn-primary alignToTitle"><i class="entypo-plus"></i><?php echo get_phrase('add_new_listing'); ?></a> <?php endif; ?>
    </div><!-- end col-->
</div>
<div class="row">
  <div class="col-lg-12">
