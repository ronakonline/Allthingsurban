<div class="hero_in shop_detail" style="background: url(<?php echo base_url('uploads/listing_thumbnails/'.$listing_details['listing_thumbnail']); ?>) center center no-repeat; background-size: cover;">
    <!-- <div class="wrapper">
